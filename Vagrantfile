...
Vagrant::Config.run do |config|
  ...
  # node0.vm.boot_mode = :gui

      # VM customization
    node0.vm.customize [
      "modifyvm", :id,
      "--name", "Wordpress - develop pages",
      "--memory", "256",
      "--cpus", "1",
    ]
  ...
  # node0.vm.network :hostonly, "192.168.33.10"
  ...
  node0.vm.forward_port 80, 8080

  # Share an additional folder to the guest VM. The first argument is
  # an identifier, the second is the path on the guest to mount the
  # folder, and the third is the path on the host to the actual folder.
  # node0.vm.share_folder "v-data", "/vagrant_data", "../data"
  ...
  #
  # node0.vm.provision :chef_client do |chef|
